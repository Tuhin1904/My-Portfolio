...
import { formSchema } from "@/schemas/createQuery";
      ...
      <DialogContent className="sm:max-w-[520px] bg-gray-900 border border-indigo-500/20 text-white p-0 overflow-hidden">
        ...
        <div className="p-6">
          <DialogHeader className="mb-5">
            ...
            <DialogDescription className="text-gray-550 text-sm">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  <Input
                    ...
                    className="bg-gray-800/60 border-white/8 text-white placeholder:text-gray-650 focus:border-indigo-500/60 focus:ring-indigo-500/20 rounded-xl"
                  />
              ...
              <div>
                <Textarea
                  ...
                  className="bg-gray-800/60 border-white/8 text-white placeholder:text-gray-655 focus:border-indigo-500/60 focus:ring-indigo-500/20 rounded-xl resize-none min-h-[100px]"
                />
